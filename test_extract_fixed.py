...
print(f"类型: {classify_json.get('type')}, 置信度: {classify_json.get('conf')}\n")
...
print("提取结果:")
print(json.dumps(extract_json, ensure_ascii=False, indent=2))
...
print(f"\n已保存到: extract_sample_output.json")
